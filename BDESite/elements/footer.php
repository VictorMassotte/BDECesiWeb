<footer class="pt-4 my-md-5 pt-md-5 border-top ">
    <div class="row">
      <div class="col-12 col-md">
        ...
        <small class="d-block mb-3 text-muted">&copy; CESI 2019</small>
      </div>
      ...
      <div class="col-6 col-md">
        ...
        <ul class="list-unstyled text-small">
          <li><a class="text-muted" href="#">Manifestations passées</a></li>
          <li><a class="text-muted" href="#">Manifestations à venir</a></li>
